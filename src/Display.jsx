...
// useEffect
  useEffect(() => {
    ...
    props.setcartnum(filteredData.reduce((acc, item) => acc + item.quantity, 0));
  }, [first]);
  ...
  const filterCategory = (e) => {
    let output = props.products.filter((product) => {
    ...
    <>
      <div className="shadow mb-5 p-2 d-flex justify-content-evenly">
        ...
        <div className="d-flex gap-3 m-4" style={{ position: "relative" }}>
          ...
          <select
            className="" name="select" onChange={handleSelect}
      ...
      style={{background:"#E6007E", color:"white", height:"80px", marginTop:"50px",padding:"30px"}}>
        <p>© 2024 www.onlineshop.com. All rights reserved.
        </p>
      </div>
    </>
  );
