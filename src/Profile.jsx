        ...
        <div className="row">
          ...
          <div className=" col m-2">
            ...
            <div className='d-grid gap-2 d-md-flex justify-content-md-end m-4'>
              <button className="btn" style={{background:"#e6007e", color:"white"}} onClick={logoutClick}>LogOut</button>
            </div>

            <div className='d-grid gap-2 d-md-flex justify-content-md-end m-4'>
              <button className="btn" style={{background:"#e6007e", color:"white"}} onClick={logoutClick}>Seller Acount</button>
            </div>
         </div>
      </div>
    </div>
